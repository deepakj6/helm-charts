...
[source, shell script]
------------------
kubectl create deployment pages --image=dellcloud/pages:1.0 --image-pull-policy=IfNotPresent
------------------
[source, shell script]
------------------
...
[source, shell script]
------------------
docker build -t dellcloud/nginx:green .
docker push dellcloud/nginx:green
------------------
...
[source, shell script]
------------------
docker build -t dellcloud/nginx:blue .
docker push dellcloud/nginx:blue
------------------

...
[source, shell script]
-------------
touch ~/workspace/helm-charts/charts/api/templates/test-api-contracts.yaml
touch ~/workspace/helm-charts/charts/api/templates/test-dbconnect-positive.yaml
touch ~/workspace/helm-charts/charts/api/templates/test-message-get.yaml
-------------

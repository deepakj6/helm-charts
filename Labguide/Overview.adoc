...
. link:https://cloud-native-labs.s3.ap-south-1.amazonaws.com/brainy/08.html#["Resource Quotas", window="_blank"]
. Design your deployment
.. link:https://cloud-native-labs.s3.ap-south-1.amazonaws.com/brainy/08.1-Assignment.html#["Pages Microservice", window="_blank"]
.. link:https://cloud-native-labs.s3.ap-south-1.amazonaws.com/brainy/08.2-Assignment.html#["Category Microservice", window="_blank"]
